...
# The only modifications are to change use CGI line and replace the
# two calls to CGI::_reset_globals() with calls to restore_parameters()
...
if ($Config{d_fork}) {
  ...
  print "ok 23 # Skip Can't fork on this OS\n";
  print "ok 24 # Skip Can't fork on this OS\n";
}
