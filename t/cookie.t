...
BEGIN {use_ok('CGI::Simple::Cookie');}
...

{
  ...
  is(ref($result{foo}), 'CGI::Simple::Cookie', 'Type of objects returned is correct');
...

{
  ...
  my $c = CGI::Simple::Cookie->new(-name    => 'foo',
               -value   => 'bar',
               -expires => '+3M',
...
{
  my $c = CGI::Simple::Cookie->new(-name    => 'Jam',
               -value   => 'Hamster',
               -expires => '+3M',
               -domain  => '.pie-shop.com',
               -path    => '/',
  ...
  $c = CGI::Simple::Cookie->new(-name    =>  'Hamster-Jam',
            -value   =>  'Tulip',
               );
...
{
  my $c1 = CGI::Simple::Cookie->new(-name    => 'Jam',
                -value   => 'Hamster',
                -expires => '+3M',
                -domain  => '.pie-shop.com',
                -path    => '/',
  ...
  my $c2 = CGI::Simple::Cookie->new(-name    => 'Jam',
                -value   => 'Hamster',
                -expires => $c1->expires,
                -domain  => '.pie-shop.com',
                -path    => '/',
  ...
  $c1 = CGI::Simple::Cookie->new(-name   => 'Jam',
             -value  => 'Hamster',
             -domain => '.foo.bar.com'
            );
  ...
  # have to use $c1->expires because the time will occasionally be
  # different between the two creates causing spurious failures.
  $c2 = CGI::Simple::Cookie->new(-name    =>  'Jam',
             -value   =>  'Hamster',
            );
